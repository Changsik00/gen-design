...
#### PoC 훅
- <a id="hook-paper-extract"></a>**`hook-paper-extract`** → spec-4-02 에서 검증. Paper 시안 → DESIGN.md 역추출 정확도 측정 (목표: 토큰 값 80% 이상 일치)
...
#### PoC 훅
- <a id="hook-paper-render"></a>**`hook-paper-render`** → spec-4-02 에서 검증. DESIGN.md / 코드 → Paper 시안 생성 자동화율 측정
