...
- **spec-4-02 이월 흡수** (2026-04-22): 앱 A 생성 과정에서 다음을 자연스럽게 검증한다.
  - LoginPage **variant 확장** — modal / bottom-sheet variant 의 왕복 정확도 (spec-4-02 는 page variant 만 검증)
  - **DashboardPage 왕복** — 데이터 집약 페이지에서도 Paper 왕복 100% 유지되는가
