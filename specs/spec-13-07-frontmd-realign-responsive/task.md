...
- [ ] `git checkout -b spec-13-07-frontmd-realign-responsive`
- Commit: 없음
...
- [ ] preset `templates/FRONT.md` — Responsive Strategy 섹션 신규
...
- [ ] §4 scenes 주석 / §8.2 흐름도 / §16 i18n / §25 표준화 — gd react 참조 제거 → LLM 생성
...
- [ ] preset `templates/AGENT.md` — LLM 생성 워크플로 + v2 레이어 + 반응형 규칙
...
- [ ] `templates/FRONT.md` / `templates/AGENT.md` preset과 동기화 (auto-gen 헤더 영역 제외)
...
- [ ] `todo-persona/src/scenes/*.tsx` 5화면 반응형 수정 (grid-cols-1 sm:... 등)
