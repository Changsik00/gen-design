...
export const FIXTURES: FixtureEntry[] = [
  ...
  { name: "dashboard-page", text: "# DashboardPage\n\n대시보드 메인 페이지 — Sidebar + Header + 본문 카드.\n\n<DashboardPage>\n  <Sidebar />\n\n  <DashboardHeader />\n\n  <ActivitySummary />\n\n  <StatCard />\n  <StatCard />\n  <StatCard />\n\n  <ActivityTable />\n</DashboardPage>\n" },
  ...
  { name: "settings-page", text: "# SettingsPage\n\n설정 페이지 — Group + 각 row type 시연.\n\n<SettingsPage>\n  <SettingsHeader />\n\n  <SettingsGroup>\n    <SettingsToggleRow />\n    <SettingsToggleRow />\n    <SettingsSelectRow />\n    <SettingsSliderRow />\n  </SettingsGroup>\n\n  <SettingsGroup>\n    <SettingsToggleRow />\n    <HomeButton />\n  </SettingsGroup>\n</SettingsPage>\n" },
