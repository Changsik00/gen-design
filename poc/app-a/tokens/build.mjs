...
StyleDictionary.registerFormat({
  name: "css/app-a-light",
  format: ({ dictionary }) => {
    const vars = dictionary.allTokens
      .map((token) => `  --${token.name}: ${token.$value ?? token.value};`)
      .join("\n");
    return `/* Auto-generated from poc/app-a/tokens.json — do not edit */\n:root {\n${vars}\n}\n`;
  },
});
...
console.log("✅ app-a 토큰 빌드 완료: src/styles/_tokens.css");
